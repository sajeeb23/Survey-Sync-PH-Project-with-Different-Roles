...
const StudentDashboard = () => {
    ...
    return (
        <div className='grid grid-cols-1 gap-5 lg:gap-0 md:grid-cols-2 lg:grid-cols-2 mt-24 mx-6'>
                ...
                <div className="card lg:w-4/5 h-full w-full bg-green-600 bg-opacity-30 text-black">
                    <div className="card-body">
                        <div className="items-center justify-center text-center">
                            ...
                            <div>
                                <p className="w-full text-2xl font-semibold">Total Notice</p>
                                <p className='text-3xl font-bold'>0
                                    <CountUp end={surveyData.length} duration={1.5} />
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="card-body">
                        <div className="items-center justify-center text-center">
                            ...
                            <div>
                                ...
                                <p className='text-3xl font-bold'>00
